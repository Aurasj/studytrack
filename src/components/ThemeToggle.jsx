...
export default function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="p-3 rounded-full bg-slate-200 dark:bg-slate-700 text-slate-600 dark:text-yellow-400 hover:bg-slate-300 dark:hover:bg-slate-600 transition-all shadow-sm"
